...
async function getStats()
{
        ...
        simple_commit = {
                user: moby_data.data[1].author['login'],
                sha: moby_data.data[1]["sha"]
        }
        test_data = JSON.stringify(simple_commit, null, 4)
        // console.log(test_data)
        json_data = JSON.stringify(moby_data, null, 4)
        fs.writeFile('mobyCommits/moby-test-commits.json', json_data, (err) => {  
             if (err) throw err;
