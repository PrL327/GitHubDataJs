...
{\color{incolor}In [{\color{incolor}1}]:} repos \PY{o}{\PYZlt{}\PYZhy{}} read.csv\PY{p}{(}\PY{l+s}{\PYZdq{}}\PY{l+s}{repos.csv\PYZdq{}}\PY{p}{,} header \PY{o}{=} \PY{k+kc}{TRUE}\PY{p}{)}
        hist\PY{p}{(}repos\PY{o}{\PYZdl{}}\PY{k+kp}{contributors}\PY{p}{[}repos\PY{o}{\PYZdl{}}contributors \PY{o}{\PYZgt{}} \PY{l+m}{0} \PY{o}{\PYZam{}} repos\PY{o}{\PYZdl{}}contributors \PY{o}{\PYZlt{}} \PY{l+m}{30}\PY{p}{]}\PY{p}{,} \PY{l+m}{10}\PY{p}{,}
             col \PY{o}{=} rainbow\PY{p}{(}\PY{l+m}{20}\PY{p}{)}\PY{p}{,} xlab \PY{o}{=} \PY{l+s}{\PYZdq{}}\PY{l+s}{Number of contributors\PYZdq{}}\PY{p}{,} 
             main \PY{o}{=} \PY{l+s}{\PYZdq{}}\PY{l+s}{Frequency of number of contributors\PYZbs{}n(for repositories with less than 30 contributors)\PYZdq{}}\PY{p}{)}
\end{Verbatim}
...
\end{Shaded}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}6}]:} from IPython.display import Image
        Image\PY{p}{(}filename\PY{o}{=}\PY{l+s}{\PYZsq{}}\PY{l+s}{newplot3.png\PYZsq{}}\PY{p}{)}
\end{Verbatim}
...
\end{Shaded}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}9}]:} Image\PY{p}{(}filename\PY{o}{=}\PY{l+s}{\PYZsq{}}\PY{l+s}{newplot2.png\PYZsq{}}\PY{p}{)}
\end{Verbatim}
...
note Markdown is noted as one of the least used but when visiting GitHub
...
multiple OS's and with a GCC compiler.
...
\end{Shaded}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}8}]:} Image\PY{p}{(}filename\PY{o}{=}\PY{l+s}{\PYZsq{}}\PY{l+s}{newplot1.png\PYZsq{}}\PY{p}{)}
\end{Verbatim}
...
\end{Shaded}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}7}]:} Image\PY{p}{(}filename\PY{o}{=}\PY{l+s}{\PYZsq{}}\PY{l+s}{newplot.png\PYZsq{}}\PY{p}{)}
\end{Verbatim}
