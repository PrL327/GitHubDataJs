...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}1}]:} import plotly as py
        from plotly.graph\PYZus{}objs import \PY{o}{*}
        import pandas
        col \PY{o}{=} \PY{p}{[}\PY{l+s}{\PYZsq{}}\PY{l+s}{name\PYZsq{}}\PY{p}{,} \PY{l+s}{\PYZsq{}}\PY{l+s}{occurences\PYZsq{}}\PY{p}{,} \PY{l+s}{\PYZsq{}}\PY{l+s}{\PYZsq{}}\PY{p}{]}
        csv\PYZus{}data \PY{o}{=} pandas.read\PYZus{}csv\PY{p}{(}\PY{l+s}{\PYZsq{}}\PY{l+s}{most\PYZus{}languages.csv\PYZsq{}}\PY{p}{,} names\PY{o}{=}\PY{k+kp}{col}\PY{p}{)}
        lang \PY{o}{=} csv\PYZus{}data.name.tolist\PY{p}{(}\PY{p}{)}
        occ \PY{o}{=} csv\PYZus{}data.occurences.tolist\PY{p}{(}\PY{p}{)}
        lang.pop\PY{p}{(}\PY{l+m}{0}\PY{p}{)}
        occ.pop\PY{p}{(}\PY{l+m}{0}\PY{p}{)}
        x \PY{o}{=} lang
        y \PY{o}{=} occ
        
        py.offline.init\PYZus{}notebook\PYZus{}mode\PY{p}{(}connected\PY{o}{=}True\PY{p}{)}
        
        py.offline.iplot\PY{p}{(}\PY{p}{\PYZob{}}
            \PY{l+s}{\PYZdq{}}\PY{l+s}{data\PYZdq{}}\PY{o}{:} \PY{p}{[}Scatter\PY{p}{(}x\PY{o}{=}lang\PY{p}{,} y\PY{o}{=}occ\PY{p}{)}\PY{p}{]}\PY{p}{,}
            \PY{l+s}{\PYZdq{}}\PY{l+s}{layout\PYZdq{}}\PY{o}{:} Layout\PY{p}{(}title\PY{o}{=}\PY{l+s}{\PYZdq{}}\PY{l+s}{Top 15 Languages\PYZdq{}}\PY{p}{)}
        \PY{p}{\PYZcb{}}\PY{p}{)}
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}2}]:} import plotly as py
        from plotly.graph\PYZus{}objs import \PY{o}{*}
        import pandas
        col \PY{o}{=} \PY{p}{[}\PY{l+s}{\PYZsq{}}\PY{l+s}{name\PYZsq{}}\PY{p}{,} \PY{l+s}{\PYZsq{}}\PY{l+s}{occurences\PYZsq{}}\PY{p}{,} \PY{l+s}{\PYZsq{}}\PY{l+s}{\PYZsq{}}\PY{p}{]}
        csv\PYZus{}data \PY{o}{=} pandas.read\PYZus{}csv\PY{p}{(}\PY{l+s}{\PYZsq{}}\PY{l+s}{least\PYZus{}languages.csv\PYZsq{}}\PY{p}{,} names\PY{o}{=}\PY{k+kp}{col}\PY{p}{)}
        lang \PY{o}{=} csv\PYZus{}data.name.tolist\PY{p}{(}\PY{p}{)}
        occ \PY{o}{=} csv\PYZus{}data.occurences.tolist\PY{p}{(}\PY{p}{)}
        lang.pop\PY{p}{(}\PY{l+m}{0}\PY{p}{)}
        occ.pop\PY{p}{(}\PY{l+m}{0}\PY{p}{)}
        ...
        py.offline.iplot\PY{p}{(}\PY{p}{\PYZob{}}
            \PY{l+s}{\PYZdq{}}\PY{l+s}{data\PYZdq{}}\PY{o}{:} \PY{p}{[}Scatter\PY{p}{(}x\PY{o}{=}lang\PY{p}{,} y\PY{o}{=}occ\PY{p}{)}\PY{p}{]}\PY{p}{,}
            \PY{l+s}{\PYZdq{}}\PY{l+s}{layout\PYZdq{}}\PY{o}{:} Layout\PY{p}{(}title\PY{o}{=}\PY{l+s}{\PYZdq{}}\PY{l+s}{Least Used 15 Languages\PYZdq{}}\PY{p}{)}
        \PY{p}{\PYZcb{}}\PY{p}{)}
\end{Verbatim}
...
bytes}\label{languages-using-the-most-bytes}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}3}]:} import plotly as py
        from plotly.graph\PYZus{}objs import \PY{o}{*}
        import pandas
        py.offline.init\PYZus{}notebook\PYZus{}mode\PY{p}{(}connected\PY{o}{=}True\PY{p}{)}
        
        col \PY{o}{=} \PY{p}{[}\PY{l+s}{\PYZsq{}}\PY{l+s}{name\PYZsq{}}\PY{p}{,} \PY{l+s}{\PYZsq{}}\PY{l+s}{totalBytes\PYZsq{}}\PY{p}{,} \PY{l+s}{\PYZsq{}}\PY{l+s}{\PYZsq{}}\PY{p}{]}
        csv\PYZus{}data \PY{o}{=} pandas.read\PYZus{}csv\PY{p}{(}\PY{l+s}{\PYZsq{}}\PY{l+s}{most\PYZus{}bytes.csv\PYZsq{}}\PY{p}{,} names\PY{o}{=}\PY{k+kp}{col}\PY{p}{)}
        lang \PY{o}{=} csv\PYZus{}data.name.tolist\PY{p}{(}\PY{p}{)}
        byte \PY{o}{=} csv\PYZus{}data.totalBytes.tolist\PY{p}{(}\PY{p}{)}
        
        
        x \PY{o}{=} lang
        y \PY{o}{=} byte
        
        trace1 \PY{o}{=} Scatter\PY{p}{(}
            x\PY{o}{=}lang\PY{p}{,}
            y\PY{o}{=}byte\PY{p}{,}
            fill\PY{o}{=}\PY{l+s}{\PYZsq{}}\PY{l+s}{tozeroy\PYZsq{}}
        \PY{p}{)}
        ...
        py.offline.iplot\PY{p}{(}\PY{p}{[}trace1\PY{p}{]}\PY{p}{)}
\end{Verbatim}
...
Bytes}\label{languages-that-use-the-least-amount-of-bytes}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}4}]:} import plotly as py
        from plotly.graph\PYZus{}objs import \PY{o}{*}
        import pandas
        py.offline.init\PYZus{}notebook\PYZus{}mode\PY{p}{(}connected\PY{o}{=}True\PY{p}{)}
        
        col \PY{o}{=} \PY{p}{[}\PY{l+s}{\PYZsq{}}\PY{l+s}{name\PYZsq{}}\PY{p}{,} \PY{l+s}{\PYZsq{}}\PY{l+s}{totalBytes\PYZsq{}}\PY{p}{,} \PY{l+s}{\PYZsq{}}\PY{l+s}{\PYZsq{}}\PY{p}{]}
        csv\PYZus{}data \PY{o}{=} pandas.read\PYZus{}csv\PY{p}{(}\PY{l+s}{\PYZsq{}}\PY{l+s}{least\PYZus{}bytes.csv\PYZsq{}}\PY{p}{,} names\PY{o}{=}\PY{k+kp}{col}\PY{p}{)}
        lang \PY{o}{=} csv\PYZus{}data.name.tolist\PY{p}{(}\PY{p}{)}
        lang.pop\PY{p}{(}\PY{l+m}{0}\PY{p}{)}
        byte \PY{o}{=} csv\PYZus{}data.totalBytes.tolist\PY{p}{(}\PY{p}{)}
        byte.pop\PY{p}{(}\PY{l+m}{0}\PY{p}{)}
        
        x \PY{o}{=} lang
        y \PY{o}{=} byte
        
        trace \PY{o}{=} Scatter\PY{p}{(}
            x\PY{o}{=}lang\PY{p}{,}
            y\PY{o}{=}byte\PY{p}{,}
            fill\PY{o}{=}\PY{l+s}{\PYZsq{}}\PY{l+s}{tozeroy\PYZsq{}}
        \PY{p}{)}
        ...
        py.offline.iplot\PY{p}{(}\PY{p}{[}\PY{k+kp}{trace}\PY{p}{]}\PY{p}{)}
\end{Verbatim}
