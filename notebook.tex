...
{\color{incolor}In [{\color{incolor} }]:} \PY{n}{repos} \PY{o}{\PYZlt{}}\PY{o}{\PYZhy{}} \PY{n}{read}\PY{o}{.}\PY{n}{csv}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{repos.csv}\PY{l+s+s2}{\PYZdq{}}\PY{p}{,} \PY{n}{header} \PY{o}{=} \PY{n}{TRUE}\PY{p}{)}
        \PY{n}{hist}\PY{p}{(}\PY{n}{repos}\PY{err}{\PYZdl{}}\PY{n}{contributors}\PY{p}{[}\PY{n}{repos}\PY{err}{\PYZdl{}}\PY{n}{contributors} \PY{o}{\PYZgt{}} \PY{l+m+mi}{0} \PY{o}{\PYZam{}} \PY{n}{repos}\PY{err}{\PYZdl{}}\PY{n}{contributors} \PY{o}{\PYZlt{}} \PY{l+m+mi}{30}\PY{p}{]}\PY{p}{,} \PY{l+m+mi}{10}\PY{p}{,}
             \PY{n}{col} \PY{o}{=} \PY{n}{rainbow}\PY{p}{(}\PY{l+m+mi}{20}\PY{p}{)}\PY{p}{,} \PY{n}{xlab} \PY{o}{=} \PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Number of contributors}\PY{l+s+s2}{\PYZdq{}}\PY{p}{,} \PY{n}{main} \PY{o}{=} \PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Frequency of number of contributors}\PY{l+s+se}{\PYZbs{}n}\PY{l+s+s2}{(for repositories with less than 30 contributors)}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}
\end{Verbatim}


    \hypertarget{languages-used-the-most}{%
...
\end{Shaded}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor} }]:} \PY{k+kn}{import} \PY{n+nn}{plotly} \PY{k}{as} \PY{n+nn}{py}
        \PY{k+kn}{from} \PY{n+nn}{plotly}\PY{n+nn}{.}\PY{n+nn}{graph\PYZus{}objs} \PY{k}{import} \PY{o}{*}
        \PY{k+kn}{import} \PY{n+nn}{pandas}
        \PY{n}{col} \PY{o}{=} \PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{name}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{occurences}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}
        \PY{n}{csv\PYZus{}data} \PY{o}{=} \PY{n}{pandas}\PY{o}{.}\PY{n}{read\PYZus{}csv}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{most\PYZus{}languages.csv}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{n}{names}\PY{o}{=}\PY{n}{col}\PY{p}{)}
        \PY{n}{lang} \PY{o}{=} \PY{n}{csv\PYZus{}data}\PY{o}{.}\PY{n}{name}\PY{o}{.}\PY{n}{tolist}\PY{p}{(}\PY{p}{)}
        \PY{n}{occ} \PY{o}{=} \PY{n}{csv\PYZus{}data}\PY{o}{.}\PY{n}{occurences}\PY{o}{.}\PY{n}{tolist}\PY{p}{(}\PY{p}{)}
        \PY{n}{lang}\PY{o}{.}\PY{n}{pop}\PY{p}{(}\PY{l+m+mi}{0}\PY{p}{)}
        \PY{n}{occ}\PY{o}{.}\PY{n}{pop}\PY{p}{(}\PY{l+m+mi}{0}\PY{p}{)}
        \PY{n}{x} \PY{o}{=} \PY{n}{lang}
        \PY{n}{y} \PY{o}{=} \PY{n}{occ}
        ...
        \PY{n}{layout} \PY{o}{=} \PY{n}{Layout}\PY{p}{(}
            \PY{n}{title}\PY{o}{=}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Top 15 Languages}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,}
            \PY{n}{xaxis}\PY{o}{=}\PY{n+nb}{dict}\PY{p}{(}
                \PY{n}{title}\PY{o}{=}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Languages}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,}
                \PY{n}{titlefont}\PY{o}{=}\PY{n+nb}{dict}\PY{p}{(}
                    \PY{n}{family}\PY{o}{=}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Arial, arial}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,}
            ...
            \PY{n}{yaxis}\PY{o}{=}\PY{n+nb}{dict}\PY{p}{(}
                \PY{n}{title}\PY{o}{=}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Occurences}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,}
                \PY{n}{titlefont}\PY{o}{=}\PY{n+nb}{dict}\PY{p}{(}
                    \PY{n}{family}\PY{o}{=}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Arial, arial}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,}
                    \PY{n}{size}\PY{o}{=}\PY{l+m+mi}{18}\PY{p}{,}
                    \PY{n}{color}\PY{o}{=}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{\PYZsh{}7f7f7f}\PY{l+s+s1}{\PYZsq{}}
        ...
        \PY{n}{py}\PY{o}{.}\PY{n}{offline}\PY{o}{.}\PY{n}{iplot}\PY{p}{(}\PY{p}{\PYZob{}}
            \PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{data}\PY{l+s+s2}{\PYZdq{}}\PY{p}{:} \PY{p}{[}\PY{n}{Scatter}\PY{p}{(}\PY{n}{x}\PY{o}{=}\PY{n}{lang}\PY{p}{,} \PY{n}{y}\PY{o}{=}\PY{n}{occ}\PY{p}{)}\PY{p}{]}\PY{p}{,}
            \PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{layout}\PY{l+s+s2}{\PYZdq{}}\PY{p}{:} \PY{n}{layout}
        \PY{p}{\PYZcb{}}\PY{p}{)}
\end{Verbatim}
...
AngularJS.
    ...
    \hypertarget{languages-used-the-least}{%
\subsection{Languages Used the Least}\label{languages-used-the-least}}

    We filtered out the \texttt{languages} table from bigquery's dataset to
only show the 15 languages with the lowest occurrences:
\texttt{sql\ SELECT\ \ \ name,\ \ \ COUNT(*)\ AS\ occurences\ FROM\ \ \ \textasciigrave{}bigquery-public-data.github\_repos.languages\textasciigrave{}\ AS\ l,\ \ \ UNNEST(l.LANGUAGE)\ GROUP\ BY\ \ \ name\ ORDER\ BY\ \ \ occurences\ \ \ limit\ 15}

    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor} }]:} \PY{n}{col} \PY{o}{=} \PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{name}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{occurences}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}
        \PY{n}{csv\PYZus{}data} \PY{o}{=} \PY{n}{pandas}\PY{o}{.}\PY{n}{read\PYZus{}csv}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{least\PYZus{}languages.csv}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{n}{names}\PY{o}{=}\PY{n}{col}\PY{p}{)}
        \PY{n}{lang} \PY{o}{=} \PY{n}{csv\PYZus{}data}\PY{o}{.}\PY{n}{name}\PY{o}{.}\PY{n}{tolist}\PY{p}{(}\PY{p}{)}
        \PY{n}{occ} \PY{o}{=} \PY{n}{csv\PYZus{}data}\PY{o}{.}\PY{n}{occurences}\PY{o}{.}\PY{n}{tolist}\PY{p}{(}\PY{p}{)}
        \PY{n}{lang}\PY{o}{.}\PY{n}{pop}\PY{p}{(}\PY{l+m+mi}{0}\PY{p}{)}
        \PY{n}{occ}\PY{o}{.}\PY{n}{pop}\PY{p}{(}\PY{l+m+mi}{0}\PY{p}{)}
        ...
        \PY{n}{layout} \PY{o}{=} \PY{n}{Layout}\PY{p}{(}
            \PY{n}{title}\PY{o}{=}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Least Used 15 Languages}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,}
            \PY{n}{xaxis}\PY{o}{=}\PY{n+nb}{dict}\PY{p}{(}
                \PY{n}{title}\PY{o}{=}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Languages}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,}
                \PY{n}{titlefont}\PY{o}{=}\PY{n+nb}{dict}\PY{p}{(}
                    \PY{n}{family}\PY{o}{=}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Arial, arial}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,}
...
\end{Shaded}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor} }]:} \PY{n}{py}\PY{o}{.}\PY{n}{offline}\PY{o}{.}\PY{n}{init\PYZus{}notebook\PYZus{}mode}\PY{p}{(}\PY{n}{connected}\PY{o}{=}\PY{k+kc}{True}\PY{p}{)}
        
        \PY{n}{col} \PY{o}{=} \PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{name}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{totalBytes}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}
        \PY{n}{csv\PYZus{}data} \PY{o}{=} \PY{n}{pandas}\PY{o}{.}\PY{n}{read\PYZus{}csv}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{most\PYZus{}bytes.csv}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{n}{names}\PY{o}{=}\PY{n}{col}\PY{p}{)}
        \PY{n}{lang} \PY{o}{=} \PY{n}{csv\PYZus{}data}\PY{o}{.}\PY{n}{name}\PY{o}{.}\PY{n}{tolist}\PY{p}{(}\PY{p}{)}
        \PY{n}{lang}\PY{o}{.}\PY{n}{pop}\PY{p}{(}\PY{l+m+mi}{0}\PY{p}{)}
        \PY{n}{byte} \PY{o}{=} \PY{n}{csv\PYZus{}data}\PY{o}{.}\PY{n}{totalBytes}\PY{o}{.}\PY{n}{tolist}\PY{p}{(}\PY{p}{)}
        \PY{n}{byte}\PY{o}{.}\PY{n}{pop}\PY{p}{(}\PY{l+m+mi}{0}\PY{p}{)}
        
        
        \PY{n}{x} \PY{o}{=} \PY{n}{lang}
        \PY{n}{y} \PY{o}{=} \PY{n}{byte}
        
        \PY{n}{trace} \PY{o}{=} \PY{n}{Scatter}\PY{p}{(}
            \PY{n}{x}\PY{o}{=}\PY{n}{lang}\PY{p}{,}
            \PY{n}{y}\PY{o}{=}\PY{n}{byte}\PY{p}{,}
            \PY{n}{fill}\PY{o}{=}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{tozeroy}\PY{l+s+s1}{\PYZsq{}}
        \PY{p}{)}
        
        
        \PY{n}{labels} \PY{o}{=} \PY{n}{lang}
        \PY{n}{values} \PY{o}{=} \PY{n}{byte}
        ...
        \PY{n}{layout} \PY{o}{=} \PY{n}{Layout}\PY{p}{(}
            ...
            \PY{p}{)}\PY{p}{)}\PY{p}{,}
            \PY{n}{yaxis}\PY{o}{=}\PY{n+nb}{dict}\PY{p}{(}
                \PY{n}{title}\PY{o}{=}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Bytes}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,}
                \PY{n}{titlefont}\PY{o}{=}\PY{n+nb}{dict}\PY{p}{(}
                    \PY{n}{family}\PY{o}{=}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Arial, arial}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,}
                    \PY{n}{size}\PY{o}{=}\PY{l+m+mi}{18}\PY{p}{,}
                    \PY{n}{color}\PY{o}{=}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{\PYZsh{}7f7f7f}\PY{l+s+s1}{\PYZsq{}}
            \PY{p}{)}\PY{p}{)}
        \PY{p}{)}
        \PY{n}{py}\PY{o}{.}\PY{n}{offline}\PY{o}{.}\PY{n}{iplot}\PY{p}{(}\PY{p}{\PYZob{}}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{data}\PY{l+s+s2}{\PYZdq{}}\PY{p}{:} \PY{p}{[}\PY{n}{trace}\PY{p}{]}\PY{p}{,} \PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{layout}\PY{l+s+s2}{\PYZdq{}}\PY{p}{:} \PY{n}{layout}\PY{p}{\PYZcb{}}\PY{p}{)}
\end{Verbatim}
...
{\color{incolor}In [{\color{incolor} }]:} \PY{n}{py}\PY{o}{.}\PY{n}{offline}\PY{o}{.}\PY{n}{init\PYZus{}notebook\PYZus{}mode}\PY{p}{(}\PY{n}{connected}\PY{o}{=}\PY{k+kc}{True}\PY{p}{)}
        ...
        \PY{n}{col} \PY{o}{=} \PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{name}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{totalBytes}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}
        \PY{n}{csv\PYZus{}data} \PY{o}{=} \PY{n}{pandas}\PY{o}{.}\PY{n}{read\PYZus{}csv}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{least\PYZus{}bytes.csv}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{n}{names}\PY{o}{=}\PY{n}{col}\PY{p}{)}
        \PY{n}{lang} \PY{o}{=} \PY{n}{csv\PYZus{}data}\PY{o}{.}\PY{n}{name}\PY{o}{.}\PY{n}{tolist}\PY{p}{(}\PY{p}{)}
        \PY{n}{lang}\PY{o}{.}\PY{n}{pop}\PY{p}{(}\PY{l+m+mi}{0}\PY{p}{)}
        \PY{n}{byte} \PY{o}{=} \PY{n}{csv\PYZus{}data}\PY{o}{.}\PY{n}{totalBytes}\PY{o}{.}\PY{n}{tolist}\PY{p}{(}\PY{p}{)}
        \PY{n}{byte}\PY{o}{.}\PY{n}{pop}\PY{p}{(}\PY{l+m+mi}{0}\PY{p}{)}
